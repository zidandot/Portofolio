            ...
            <div className="flex flex-wrap lg:flex-row-reverse">
                <div className="w-full lg:w-1/2">
                    <div className="flex justify-center lg:p-8">
                        <motion.img 
                            src={poto} alt="Muhammad Zidan Alhilali" 
                            className="border border-stone-900 rounded-3xl" 
                            width={650}
                            height={650}
                            initial={{ x: 100, opacity: 0 }} 
                            animate={{ x: 0, opacity: 1 }}
                            transition={{ duration: 1, delay: 1.5 }}></motion.img>
                    </div>
                </div>
                <div className="w-full lg:w-1/2">
                    <motion.div 
                        ...
                        <motion.h2
                            ...
                            className="pb-2 text-4xl tracking-tighter lg:text-8xl">Muhammad Zidan Alhilali</motion.h2>
                        <motion.span
                            variants={childVariants}
                        ...
                        <motion.a
                            variants={childVariants} 
                            href="/public/CV_Muhammad Zidan Alhilali.pdf"
                            target="_blank"
